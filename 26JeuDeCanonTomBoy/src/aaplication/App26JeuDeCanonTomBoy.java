...
public class App26JeuDeCanonTomBoy extends JFrame {
	 ...
	 *
	 * @param args J'en ai aucune idée.
	 */
	...
	public App26JeuDeCanonTomBoy() {
		...
		composantAnime.addPhysicsListener(new PhysicsListener() {
			...
			public void checkAccelMagneticX(double accelMagneticX) {
				if(isModeScience)lblAccelForceMagnetiqueX.setText("<html><body>Accélération en x causée par la force magnétique : " + String.format("%.2f",accelMagneticX) + " m/s<sup>2</sup></body></html>");

			}
			@Override
			public void checkAccelMagneticY(double accelMagneticY) {
				if(isModeScience)lblAccelForceMagnetiqueY.setText("<html><body>Accélération en Y causée par la force magnétique : " + String.format("%.2f",accelMagneticY) + " m/s<sup>2</sup></body></html>");
			...
			public void checkAccelMagneticTotal(double accelMagneticTotal) {
				if(isModeScience)lblAccelForceMagnetiqueResultante.setText("<html><body>Accélération résultante causée par la force magnétique : " + String.format("%.2f", Math.abs(accelMagneticTotal)) + " m/s<sup>2</sup></body></html>");
			...
			public void accelGravitationelle(double accelGravita) {
				if(isModeScience)lblAccelGravitationnelle.setText("<html><body>Accélération gravitationelle : " + String.format("%.2f",accelGravita)  +" m/s<sup>2</sup></body></html>");
			}
			@Override
