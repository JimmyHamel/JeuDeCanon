 ...
 * 
 * @author Jimmy
 * Classe représentant les différent utilisateur du profil. Les objets 
 * profils contients une image, un chiffre représentant le niveau ou l'utilisateur est rendu
 * et une chaine de caractere représentant le nom du profil.
 * Date de création : 8 mars 2016
 * 
 */
public class Profil implements Serializable {
	...
	/**
	 * Methode retournant le niveau où le profil est rendu
	...
	/**
	 * Methode retournant le numéro de l'image du joueur choisie
	 * @return Le numéro de l'image du joueur choisi
	 */
	public int getIndexImage() {
		return this.numeroImage;
	}
	/**
	 * methode mofidifant Le numéro de l'image de profil choisie
	 * @param indexImage Le numéro de l'image de profil choisie
	 */
