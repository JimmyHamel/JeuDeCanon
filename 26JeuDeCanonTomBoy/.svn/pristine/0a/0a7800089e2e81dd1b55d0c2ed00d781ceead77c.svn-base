 ...
 */
	public FenetreInstruction() {
		...
		txtpnTests.setText("<html><b>Tests suggérés</b><br>"
				...
				+ "Cependant, si vous ne trouvez pas ce test satisfaisant, vous pouvez aller dans le menu principal et choisir <i>Sélection de niveaux</i>. De là, vous alez à la dernière "
				+ "page et vous choisissez le niveau éditable. Maintenant, vous appuyez sur le bouton <i>Démarrer</i>.<br>"
				+ "D'ici, vouz avez une fenêtre qui s'ouvre à côté de votre espace de jeu principal. Vous survolez les étiquettes pour savoir exactement ce que sont les paramètres. <br>"
				+ "Un test serait de mettre la longueur et la hauteur de tous les ennemis à 10 et les types à <i>simple</i> et le nombre d'ennemis à 12. "
				+ "Sinon, choisir des valeurs aléatoires pour chaque paramètre. </html>");
		txtpnTests.setBounds(0, 0, 630, 475);
